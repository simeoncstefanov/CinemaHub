    ...
    public partial class InitialCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaWatchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaWatchers_Media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MediaWatchers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaWatchers_MediaId",
                table: "MediaWatchers",
                column: "MediaId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaWatchers_UserId",
                table: "MediaWatchers",
                column: "UserId");
